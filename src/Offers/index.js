...
const offersData = [
  ...
  },
  {
    ...
    info: 'Из Москвы в США от 20680 рублей! Специальное предложение от авиакомпании Lufthansa',
  },
  {
    ...
    price: '20 360 ₽',
    daysLeft: 'Осталось 19 дней',
    info: 'Из Москвы в США от 22360 рублей! Специальное предложение от авиакомпании Lufthansa',
  },
];
    ...
    <div className="container">
      ...
      <div className="row center-xs">
        ...
        <div className="col-xs-12 col-md-4 col-xl-3">
          <Card data={offersData[0]} />
        </div>
        <div className="hidden-xs hidden-sm hidden-md hidden-lg col-xl" />
        <div className="col-xs-12 col-md-4 col-xl-3">
          <Card data={offersData[1]} />
        </div>
        <div className="hidden-xs hidden-sm hidden-md hidden-lg col-xl" />
        <div className="col-xs-12 col-md-4 col-xl-3">
          <Card data={offersData[2]} />
        </div>
        <div className="hidden-xs hidden-sm hidden-md hidden-lg col-xl-1" />
